...
type LoggingInterface interface {
	...
	GetNamespace(name, namespace string, opts metav1.GetOptions) (*Logging, error)
...
func (s *loggingClient) GetNamespace(name, namespace string, opts metav1.GetOptions) (*Logging, error) {
...
func (s *loggingClient) DeleteNamespace(name, namespace string, options *metav1.DeleteOptions) error {
