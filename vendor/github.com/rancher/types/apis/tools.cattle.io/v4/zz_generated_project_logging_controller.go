...
type ProjectLoggingInterface interface {
	...
	GetNamespace(name, namespace string, opts metav1.GetOptions) (*ProjectLogging, error)
...
func (s *projectLoggingClient) GetNamespace(name, namespace string, opts metav1.GetOptions) (*ProjectLogging, error) {
...
func (s *projectLoggingClient) DeleteNamespace(name, namespace string, options *metav1.DeleteOptions) error {
